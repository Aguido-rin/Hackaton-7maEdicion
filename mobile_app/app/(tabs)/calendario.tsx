            ...
            {selectedEvent && (
              <>
                ...
                <Pressable
                  ...
                  onPress={() => {
                    // Aquí en el futuro integran con el calendario del dispositivo
                    // Por ahora solo mostramos un mensaje o lo dejamos como botón "próximamente"
                    console.log('Agregar al calendario (futuro)');
                  }}
                >

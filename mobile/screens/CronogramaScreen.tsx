...
type Props = BottomTabScreenProps<TabParamList, "Cronograma">;
...
const eventosGenerales: EventoGeneral[] = [
  { fecha: "11/01/2026", mes: "Enero", evento: "Fecha límite para renuncia de candidatos y retiro de listas." },
  {
    fecha: "12/01/2026",
    mes: "Enero",
    evento: "Fecha límite para la presentación de solicitudes de inscripción de fórmulas y listas de candidatos.",
  },
  {
    fecha: "13/01/2026",
    mes: "Enero",
    evento: "Fecha límite para resolver exclusiones y tachas en primera instancia.",
  },
